...
// 查询文件配置详情
export const getFileConfigApi = (id: string) => {
  return request.get({ url: '/infra/file/config/get?id=' + id })
}

// 更新文件配置为主配置
export const updateFileConfigMasterApi = (id: string) => {
...
// 删除文件配置
export const deleteFileConfigApi = (id: string) => {
  return request.delete({ url: '/infra/file/config/delete?id=' + id })
}

// 测试文件配置
export const testFileConfigApi = (id: string) => {
